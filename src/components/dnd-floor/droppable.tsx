...
export const Droppable = memo(({ droppableId }: DroppableProps) => {
    ...
    return (
        <div
            ref={setNodeRef}
            className={`relative h-[calc(950px*0.8)] w-[calc(1280px*0.8)] border border-primary md:mx-auto xl:w-[calc(1920px*0.8)]  ${isDisabled ? "" : "bg-dots-craft bg-[size:40px_40px]"}`}
        >
